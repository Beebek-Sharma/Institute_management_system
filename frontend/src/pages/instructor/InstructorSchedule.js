            ...
            <div className="min-h-screen bg-transparent">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                        {scheduledByDay[day].map(schedule => (
                                            <div key={schedule.id} className="bg-white border border-gray-200 rounded-lg p-4">
                                                <div className="mb-3">
                                                    <h4 className="font-bold text-gray-900 mb-1">{schedule.course_name || 'Unknown Course'}</h4>
                                                    <p className="text-sm text-gray-700">{schedule.batch_info || 'No batch specified'}</p>
                                                </div>
                ...
                {schedules.length === 0 && !loading && (
                    <div className="text-center py-12 bg-white backdrop-blur-md border border-gray-200 rounded-lg">
                        ...
                        <p className="text-gray-700 text-sm mt-2">Contact admin to get your class schedule set up</p>
                    </div>
                )}
