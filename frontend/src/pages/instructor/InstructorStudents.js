        ...
        <DashboardLayout>
            <div className="min-h-screen bg-transparent">
                ...
                <div className="bg-white backdrop-blur-md border-b border-gray-200 p-6 mb-8 rounded-lg">
                    <h1 className="text-4xl font-bold text-gray-900 mb-2">My Students</h1>
                    <p className="text-gray-900">View students enrolled in your courses</p>
                </div>
                            ...
                            <table className="w-full">
                                <thead>
                                    <tr className="border-b border-gray-200 bg-white">
                                        ...
                                        <th className="px-6 py-4 text-left text-gray-700 font-semibold">Enrollment Date</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {filteredStudents.map((student) => (
                                        <tr key={`${student.id}-${student.course_id}`} className="border-b border-gray-200 hover:bg-white transition">
