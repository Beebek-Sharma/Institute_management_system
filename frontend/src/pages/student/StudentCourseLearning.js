          ...
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-lg p-6 sm:p-8">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div className="flex-1">
                <Badge className="mb-2 bg-teal-500/20 text-teal-300 border-teal-500/30">
                  {course.code}
                </Badge>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="bg-white/10 border-white/20">
              <CardHeader className="pb-3">
                <CardTitle className="text-sm font-semibold text-gray-300">Enrollment Status</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="text-3xl font-bold text-green-400 mb-2">Active</div>
                <p className="text-gray-400 text-sm">You are actively enrolled</p>
              </CardContent>
            </Card>

            <Card className="bg-white/10 border-white/20">
              <CardHeader className="pb-3">
                <CardTitle className="text-sm font-semibold text-gray-300">Enrollment Date</CardTitle>
              </CardHeader>
              <CardContent>
                ...
                <p className="text-gray-400 text-sm">Date you joined</p>
              </CardContent>
            </Card>

            <Card className="bg-white/10 border-white/20">
              <CardHeader className="pb-3">
                <CardTitle className="text-sm font-semibold text-gray-300">Progress</CardTitle>
              </CardHeader>
              <CardContent>
              ...
              <div className="bg-white/5 border border-white/10 rounded-lg p-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-white font-semibold">Course Overview</p>
                      <p className="text-gray-400 text-sm">Getting started with {course.name}</p>
                    </div>
                  </div>
                  <Button
              ...
              <div className="bg-white/5 border border-white/10 rounded-lg p-4 opacity-50">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-gray-400 font-semibold">Course Content</p>
                      <p className="text-gray-500 text-sm">Locked - Complete overview first</p>
                    </div>
                  </div>
                </div>
              </div>
