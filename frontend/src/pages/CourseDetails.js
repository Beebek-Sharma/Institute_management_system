                            ...
                            <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
                                ...
                                <div className="md:col-span-3">
                                    <div className="sticky top-32 space-y-6">
                                        ...
                                        {/* Course Info */}
                                        <div className="bg-white border border-gray-200 rounded-xl p-4 shadow-sm">
                                            <h3 className="font-bold text-gray-900 mb-4 text-sm">About This Course</h3>
                                        ...
                                        {/* Enrollment Status */}
                                        <div className={`border rounded-xl p-4 ${isEnrolled ? 'bg-green-50 border-green-200' : 'bg-blue-50 border-blue-200'}`}>
                                            <div className="flex items-start gap-2">
                                                <CheckCircle className={`w-5 h-5 flex-shrink-0 mt-0.5 ${isEnrolled ? 'text-green-600' : 'text-blue-600'}`} />
                                                <div>
                                                    <p className={`font-bold text-sm ${isEnrolled ? 'text-green-900' : 'text-blue-900'}`}>
                                                        {isEnrolled ? 'You are enrolled' : 'Ready to enroll?'}
                                                    </p>
                                                    <p className={`text-xs mt-1 ${isEnrolled ? 'text-green-700' : 'text-blue-700'}`}>
                                                        {isEnrolled ? 'Start learning now' : 'Financial aid available'}
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
