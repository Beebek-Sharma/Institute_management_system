...
const AdminEnrollments = () => {
    ...
    const getStatusColor = (status) => {
        const colors = {
            active: 'bg-green-50 text-green-300 border-green-500/30',
            completed: 'bg-blue-500/20 text-blue-300 border-blue-500/30',
            dropped: 'bg-red-50 text-red-600 border-red-500/30',
        ...
        <DashboardLayout>
            <div className="min-h-screen bg-transparent">
                ...
                <div className="bg-white backdrop-blur-md border-b border-gray-200 p-6 mb-8 rounded-lg">
                    ...
                    <p className="text-gray-900">Manage student enrollments and approvals</p>
                </div>
                ...
                {/* Enrollments Table */}
                {loading ? (
                    <div className="text-center py-12 text-gray-700">Loading enrollments...</div>
                ) : (
                            ...
                            <table className="w-full">
                                <thead>
                                    <tr className="border-b border-gray-200 bg-white">
                                        ...
                                        <th className="px-6 py-4 text-left text-gray-700 font-semibold">Progress</th>
                                        <th className="px-6 py-4 text-left text-gray-700 font-semibold">Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {filteredEnrollments.map((enrollment) => (
                                        <tr key={enrollment.id} className="border-b border-gray-200 hover:bg-white transition">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                    <div className="bg-white backdrop-blur-md border border-gray-200 rounded-lg p-6">
                        <div className="text-gray-700 text-sm font-semibold mb-2">Total Enrollments</div>
                        <div className="text-4xl font-bold text-gray-900">{enrollments.length}</div>
                    </div>
                    <div className="bg-white backdrop-blur-md border border-gray-200 rounded-lg p-6">
                        <div className="text-gray-700 text-sm font-semibold mb-2">Active</div>
                        <div className="text-4xl font-bold text-green-400">
                            {enrollments.filter(e => e.status === 'active').length}
                        </div>
                    </div>
                    <div className="bg-white backdrop-blur-md border border-gray-200 rounded-lg p-6">
                        <div className="text-gray-700 text-sm font-semibold mb-2">Pending Approval</div>
                        ...
                        <form onSubmit={handleManualEnroll} className="space-y-4">
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    className="w-full px-4 py-3 bg-white border border-gray-300 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500/50 disabled:opacity-50"
                                >
