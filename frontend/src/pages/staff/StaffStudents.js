        ...
        <DashboardLayout>
            <div className="min-h-screen bg-transparent">
                ...
                <div className="bg-white backdrop-blur-md border-b border-gray-200 p-6 mb-8 rounded-lg">
                    ...
                    <p className="text-gray-900">View and manage all students</p>
                </div>
                ...
                <div className="bg-white backdrop-blur-md border border-gray-200 rounded-lg p-6 mb-6">
                    <div className="flex flex-col md:flex-row gap-4 mb-4">
                        ...
                        <button
                            onClick={() => navigate('/staff/create-student')}
                                ...
                                filteredStudents.map((student) => (
                                    <div key={student.id} className="bg-white backdrop-blur-md border border-gray-200 rounded-lg p-4">
                                        ...
                                        <div className="space-y-2 mb-4 border-t border-gray-200 pt-3">
                                            ...
                                            <p className="text-xs text-gray-700">
                                                <span className="text-gray-700">Enrollments:</span> {student.enrollment_count || 0} courses
                                            </p>
                                        </div>
                                        <button
                                            onClick={() => viewStudentDetails(student)}
                ...
                <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-white backdrop-blur-md border border-gray-200 rounded-lg p-6">
                        <div className="text-gray-700 text-sm font-semibold mb-2">Total Students</div>
                ...
                <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-3 sm:p-4">
                    <div className="bg-white/95 backdrop-blur-lg rounded-2xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto border border-gray-300 p-4 sm:p-8">
                        ...
                        <div className="space-y-4 sm:space-y-6">
                            ...
                            {/* Enrollment History */}
                            <div>
                                <h3 className="text-lg font-bold text-gray-900 mb-3">Enrollment Info</h3>
