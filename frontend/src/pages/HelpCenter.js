        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="relative max-w-2xl">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 bg-white border border-gray-300 rounded-lg text-white placeholder:text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500/50"
            />
          </div>
        </div>
