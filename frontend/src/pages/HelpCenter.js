      ...
      <div className="min-h-screen bg-gray-50">
        <div className="bg-white backdrop-blur-md border-b border-gray-200 p-6 mb-8 rounded-lg">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-gray-900">Find answers to your questions</p>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="mb-12">
            <div className="relative max-w-2xl">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 bg-white border border-gray-300 rounded-lg text-gray-900 placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <a href="#" className="bg-white backdrop-blur-md border border-gray-200 rounded-lg p-6 hover:border-gray-300 transition">
              <BookOpen className="w-8 h-8 text-blue-600 mb-3" />
              <h3 className="text-gray-900 font-semibold mb-2">Courses</h3>
              <p className="text-gray-700 text-sm">Learn about course enrollment and access</p>
            </a>
            <a href="#" className="bg-white backdrop-blur-md border border-gray-200 rounded-lg p-6 hover:border-gray-300 transition">
              <Users className="w-8 h-8 text-purple-600 mb-3" />
              <h3 className="text-gray-900 font-semibold mb-2">Community</h3>
              <p className="text-gray-700 text-sm">Connect with other learners and instructors</p>
            </a>
            <a href="#" className="bg-white backdrop-blur-md border border-gray-200 rounded-lg p-6 hover:border-gray-300 transition">
              <MessageCircle className="w-8 h-8 text-green-600 mb-3" />
              <h3 className="text-gray-900 font-semibold mb-2">Support</h3>
              <p className="text-gray-700 text-sm">Contact our support team for assistance</p>
            </a>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="space-y-6">
              {faqs.map((section, idx) => (
                <div key={idx} className="bg-white backdrop-blur-md border border-gray-200 rounded-lg p-6">
          ...
          {/* Contact Section */}
          <div className="bg-white backdrop-blur-md border border-gray-200 rounded-lg p-8 mb-12">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">Still need help?</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <a href="/contact" className="flex items-center gap-3 p-4 bg-white rounded-lg hover:bg-white transition">
                <MessageCircle className="w-6 h-6 text-blue-400" />
                <div>
                  <h4 className="text-gray-900 font-semibold">Contact Support</h4>
                  <p className="text-gray-700 text-sm">Send us a message</p>
                </div>
              </a>
              <a href="mailto:support@example.com" className="flex items-center gap-3 p-4 bg-white rounded-lg hover:bg-white transition">
              ...
              <a href="tel:+1234567890" className="flex items-center gap-3 p-4 bg-white rounded-lg hover:bg-white transition">
